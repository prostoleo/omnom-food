<template>
  <li v-editable="blok" class="card overflow-hidden">
    <img class="w-full object-cover" :src="blok.images[0].filename" alt="" />
    <div class="card-body p-3">
      ...
      <div class="mt-4 flex items-center justify-between">
        ...
        <button
          class="inline-block px-4 py-2 text-yellow-500 rounded-md border-2 border-solid border-yellow-500 font-semibold"
          add-to-cart
